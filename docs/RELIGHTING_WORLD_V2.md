...
**Atualização posterior:** o usuário confirmou melhora do chão e da pele na sessão da V2. A análise do log e a otimização V2.1 estão em [resultado e redução de custo](RELIGHTING_V2_OPTIMIZATION.md). Os números e a instalação abaixo documentam a V2 original.
